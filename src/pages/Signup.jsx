      ...
      <div className="flex flex-1 flex-col justify-center pb-10">
        <div className="mb-10">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-3xl font-semibold tracking-tight text-paper">Create account</span>
          </div>
        ...
        >
          <label className="flex flex-col gap-1.5">
            <span className="font-mono text-[11px] uppercase tracking-[0.12em] text-paper/50">Full name</span>
